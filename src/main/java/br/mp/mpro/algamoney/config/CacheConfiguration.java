...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(br.mp.mpro.algamoney.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(br.mp.mpro.algamoney.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            ...
            cm.createCache(br.mp.mpro.algamoney.domain.Contato.class.getName(), jcacheConfiguration);
            cm.createCache(br.mp.mpro.algamoney.domain.Pessoa.class.getName() + ".contatos", jcacheConfiguration);
