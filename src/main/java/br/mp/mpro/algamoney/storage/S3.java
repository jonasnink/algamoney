package br.mp.mpro.algamoney.storage;
...
//    public S3(AmazonS3 amazonS3, ApplicationProperties property) {
...
//
//        try {
//            PutObjectRequest putObjectRequest = new PutObjectRequest( property.getS3().getBucket(), nomeUnico, arquivo.getInputStream(), objectMetadata ).withAccessControlList(acl);
