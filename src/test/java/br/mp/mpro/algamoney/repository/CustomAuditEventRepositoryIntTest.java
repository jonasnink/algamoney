...
import br.mp.mpro.algamoney.config.audit.AuditEventConverter;
import br.mp.mpro.algamoney.domain.PersistentAuditEvent;
...
import static br.mp.mpro.algamoney.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
