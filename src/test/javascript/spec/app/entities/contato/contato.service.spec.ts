    ...
    describe('Contato Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Contato', () => {
                service.create(new Contato(null)).subscribe(received => {
            ...
            it('should update a Contato', () => {
                service.update(new Contato(123)).subscribe(received => {
