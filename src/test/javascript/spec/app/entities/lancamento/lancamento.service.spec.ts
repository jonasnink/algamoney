    ...
    describe('Lancamento Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/lancamentos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Lancamento', () => {
                service.create(new Lancamento(null)).subscribe(received => {
            ...
            it('should update a Lancamento', () => {
                service.update(new Lancamento(123)).subscribe(received => {
